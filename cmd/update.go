...
// update self-updates the slides2pdf binary by cloning the latest source from GitHub,
...
var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update slides2pdf to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "slides2pdf-update-*")
	if err != nil {
